...
export const Transactions = () => {
  ...
  return (
    <div className='flex flex-col gap-2'>
      ...
      <Button color='primary' size='lg' text={uploadLoading ? 'Loading ...' : 'Register'} stretch rounded='medium' onclick={() => registerCar({ dealer, vehicle_type, chases_no, vehicle_color, vehicle_color_hex_code, status, branch, setLoading: setUploadLoading })} />
    </div>
  )
}